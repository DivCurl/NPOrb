...
// Note: table starts at ascii val '32' (space)
/*
const char ascii[ ] = {
    0xFF, 0x40, 0x20, 0x10, 0x8, 0x4, 0x2, 0xFF   // N
    
};

// Returns pointer to single ascii character
sprite CharLookup( char chr ) {    
    // Retrieve (1) of (8) bytes of character's pixel bitmap and store in sprite
